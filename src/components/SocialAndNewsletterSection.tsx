...
/**
 * Section combinant les réseaux sociaux et l'inscription à la newsletter
...
const socialLinks = [
  ...
  {
    href: "https://www.youtube.com/@acelest",
    icon: (
      <svg
        className="h-6 w-6"
        fill="currentColor"
  ...
  {
    href: "https://www.instagram.com/acelest",
    icon: (
      <svg
        className="h-6 w-6"
        fill="currentColor"
  ...
  {
    href: "https://discord.gg/VEqe3kuJ",
    icon: (
      <svg
        className="h-6 w-6"
        fill="currentColor"
          ...
          <div className="space-y-8">
            <div className="text-center md:text-left">
              <h2 className="text-2xl md:text-3xl font-bold mb-3 text-gray-900 dark:text-gray-100">
                {isEnglishPath ? "Connect with me" : "Connectez-vous avec moi"}
              </h2>
              <p className="text-gray-600 dark:text-gray-400">
                {isEnglishPath
                  ? "Follow me on social media to stay updated with the latest content and news."
                  : "Suivez-moi sur les réseaux sociaux pour rester à jour avec mes derniers contenus et actualités."}
              </p>
            </div>
